		...
		return array(
			...
			'Post' => array(
				...
				'properties' => array(
					...
					'word_count' => array('type' => 'integer', 'description' => 'Words in this post body, counted after the same flattening as excerpt (v1.37.0+: block boundaries separate words, a bare "<" in prose no longer truncates the count, entities and script/style contents no longer count as words). Computed per request from the body, so it is present for EVERY status - drafts included - and never null. Not attributed to any single author. Still present when ?content=0 omits the body.'),
